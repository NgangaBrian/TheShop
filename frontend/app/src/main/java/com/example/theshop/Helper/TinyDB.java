...
public class TinyDB {
    ...
    // Check if external storage is writable or not. return true if writtable and false if not
    public static boolean isExternalStorageWritable(){
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState());
    }

    // Check is external storage is readable or not
    ...
    //Return the string path of the last saved image
    public String getSavedImagePath(){
        return lastImagePath;
    }

    // Save 'theBitmap' into folder 'theFolder' with the name 'theImageName'
